  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        # Focus (mirrors aerospace ctrl-alt-hjkl)
        "$mod, H, movefocus, l"
        "$mod, J, movefocus, d"
        "$mod, K, movefocus, u"
        "$mod, L, movefocus, r"

        # Move windows (mirrors aerospace ctrl-alt-shift-hjkl)
        ...
        # Workspaces (mirrors aerospace ctrl-alt-N)
        "$mod, 1, workspace, 1"
        "$mod, 2, workspace, 2"
        "$mod, 3, workspace, 3"
        "$mod, 4, workspace, 4"
        ...
        # Move to workspace (mirrors aerospace ctrl-alt-shift-N)
